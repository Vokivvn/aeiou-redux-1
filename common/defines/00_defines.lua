...
NCountry = {
	...
	MAJOR_MIN_FACTORIES = 10000,						-- need at least these many factories to become a major
...
NProduction = {
	...
	MAX_MIL_FACTORIES_PER_LINE = 1000,
	...
	BASE_FACTORY_SPEED_MIL = 1.0, 				-- Base factory speed multiplier (how much hoi3 style IC each factory gives).
	BASE_FACTORY_SPEED_NAV = 1.0, 				-- Base factory speed multiplier (how much hoi3 style IC each factory gives).
...
NMilitary = {
	...
	SUPPLY_GRACE = 2160,							   -- troops always carry 3 days of food and supply
	...
	MAX_OUT_OF_SUPPLY_DAYS = 60, 				   -- how many days of shitty supply until max penalty achieved
